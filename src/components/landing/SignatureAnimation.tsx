...
export default function SignatureAnimation() {
  ...
  return (
    <div className="relative w-full max-w-[400px] h-[200px] flex items-center justify-center mx-auto my-12">
      ...
      {/* 1. THE PAPER TEXTURE BACKGROUND */}
      ...
      <div className="absolute inset-0 bg-[#0a0a0a] border border-[#D4AF37]/20 rounded-xl transform rotate-1 flex items-center justify-center overflow-hidden">
         ...
         <svg width="300" height="100" viewBox="0 0 300 100" className="overflow-visible">
            ...
            />
            {/* "TeslaInvest" Text simulated with path above - simplified for reliable animation */}
         </svg>
         ...
         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <motion.h2 
              ...
              className="text-5xl font-serif text-[#D4AF37] font-italic" 
         ...
         <motion.div 
           ...
           animate={{ scale: showSeal ? 1 : 2, opacity: showSeal ? 1 : 0 }}
           transition={{ type: "spring", stiffness: 300, damping: 20 }}
           className="absolute bottom-4 right-4 w-16 h-16 bg-red-800 rounded-full border-4 border-red-900 shadow-lg flex items-center justify-center rotate-12"
         >
