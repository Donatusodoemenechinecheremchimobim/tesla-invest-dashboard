  ...
  return (
    <main className="bg-[#050505] text-white overflow-hidden">
      ...
      <section className="relative h-[80vh] flex items-center justify-center text-center px-6">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} className="relative z-10 max-w-4xl mx-auto w-full">
          <p className="text-[#D4AF37] text-xs font-bold uppercase tracking-[0.3em] mb-6">Private Client Group</p>
          {/* UPDATED: text-5xl for mobile, scaling up to 9xl for PC to prevent cutoff */}
          <h1 className="text-5xl sm:text-7xl md:text-9xl font-serif mb-10 leading-none break-words">Legacy <br /> Architecture.</h1>
      ...
      <section className="py-20 md:py-32 px-6 max-w-[1400px] mx-auto grid md:grid-cols-3 gap-8">
        {[
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: i*0.2 }} key={i} className="bg-[#111] p-8 md:p-12 rounded-[2rem] border border-white/5 hover:border-[#D4AF37] transition-colors group">
