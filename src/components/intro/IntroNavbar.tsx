        ...
        <div className="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
              ...
              className="lg:hidden p-2 text-white hover:text-[#D4AF37] transition-colors z-50"
            >
            ...
            <div className="flex flex-col gap-2">
              {links.map((link, i) => (
                ...
                >
                  <Link 
                    ...
                    className="flex items-center justify-between p-6 border-b border-white/10 text-xl font-serif text-white hover:text-[#D4AF37] transition-colors group"
                  >
                    {link.name}
              ...
              >
                <Link 
                  href="/portal" 
                  onClick={() => setIsOpen(false)}
                  className="flex w-full items-center justify-center gap-2 bg-[#D4AF37] text-black font-bold uppercase tracking-widest text-xs py-5 rounded-xl shadow-[0_0_20px_rgba(212,175,55,0.3)]"
                >
